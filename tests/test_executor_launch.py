...
def valid_inception_output(marker: str = "Plan ready.") -> str:
    return (
        ...
        "## User Stories\n\n"
        "US-001 captures deterministic interpreter behavior.\n\n"
        "## Non-functional requirements\n\n"
        "Determinism and bounded execution are required.\n\n"
        "## Measurement Criteria\n\n"
        "Automated tests prove the acceptance criteria.\n\n"
        "## Proposed Units\n\n"
        ...
        "## Risk Register\n\n"
        "Semantic drift is mitigated by tests against the canonical model.\n\n"
