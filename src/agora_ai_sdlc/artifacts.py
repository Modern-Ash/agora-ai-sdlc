...
PREFIX = {
    ...
    "requirements": "REQ", "user-stories": "UST", "nfr": "NFR", "risk-register": "RSK",
    "measurement-criteria": "MCR", "prfaq": "PRF", "domain-model": "DOM", "logical-design": "LOG",
    "architecture": "ARC", "threat-model": "THR", "test-strategy": "TST",
    "implementation-plan": "IMP", "deployment-unit": "DPU", "deployment-plan": "DEP",
    "rollback-procedure": "RBK", "operational-readiness": "OPR", "learning-record": "LRN",
    "rework-record": "RWK", "plan": "PLN", "bolt-plan": "BLP", "impact-analysis": "IMA",
    "change-request": "CRQ", "change-plan": "CHP", "configuration-delta": "CFD",
    "static-system-model": "SSM", "dynamic-system-model": "DSM",
...
PARENTS: dict[str, tuple[str, ...] | None] = {
    ...
    "user-stories": ("requirements", "unit-of-work"), "nfr": ("requirements", "unit-of-work"),
    "risk-register": ("requirements", "nfr", "unit-of-work"),
    "measurement-criteria": ("requirements", "user-stories", "unit-of-work"),
    "prfaq": ("intent", "unit-of-work"),
    "domain-model": ("requirements", "user-stories"),
    "logical-design": ("domain-model", "nfr", "risk-register"),
    "architecture": ("requirements", "domain-model", "logical-design"),
    "threat-model": ("architecture", "logical-design"), "test-strategy": ("requirements", "user-stories", "nfr"),
    "implementation-plan": ("architecture", "logical-design", "test-strategy"),
    "deployment-unit": ("implementation-plan", "test-strategy", "logical-design"),
    "deployment-plan": ("implementation-plan", "deployment-unit"), "rollback-procedure": ("deployment-plan",),
    "operational-readiness": ("deployment-plan",), "learning-record": None, "rework-record": None, "plan": None,
    "bolt-plan": ("unit-of-work", "plan"), "impact-analysis": ("unit-of-work", "plan", "bolt-plan"),
    "change-request": ("unit-of-work", "impact-analysis"), "change-plan": ("change-request", "plan"),
    "configuration-delta": ("change-plan",),
    "static-system-model": ("legacy-inventory", "dependency-map"),
    "dynamic-system-model": ("static-system-model", "characterization"),
