...
- **Integrations**: GitHub, generic CI/CD, security findings, observability, GitLab/Jira via provider-neutral Tool Pack operations; external systems remain operational sources.
