...
def _inception_prompt(root: Path, handoff_path: Path) -> str:
    ...
    return (
        ...
        "Stay in Inception: inspect only bounded relevant context, prepare the Level 1 Plan, User Stories, "
        "NFRs, Measurement Criteria, cohesive Units and useful Bolts, trace acceptance criteria, identify "
        "risks/constraints/dependencies, and persist "
        ...
        "Intent interpretation; Material clarifications; Level 1 Plan; User Stories; Non-functional requirements; "
        "Measurement Criteria; Proposed Units; Suggested Bolts; Acceptance criteria trace; Risk Register; "
        "Risks, constraints and dependencies; Source facts and proposed decisions; "
