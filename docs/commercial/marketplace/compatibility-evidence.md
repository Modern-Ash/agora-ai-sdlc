...
| --- | --- | --- | --- |
| Current result | **PASS** (executable repository conformance) | **PASS** (executable repository conformance against the public profile) | **PASS** (additive governance only) |
| PASS | ai-initiated-planning, bolts, brownfield-semantic-elevation, deployment-units, domain-design, forward-backward-traceability, human-validation, intent, level-1-plan, logical-design, measurement-criteria, minimal-roles, non-functional-requirements, operations-governed-remediation, operations-observability, persistent-context, prfaq, quality-reviewer, recursive-planning, risk-register, three-phase-lifecycle, units, user-stories | change-configuration-management, code-review, cross-repository-impact, documentation, domain-knowledge, ideation, operational-rules, organizational-readiness, quality-governance, review-gates, risk-issue-management, security-compliance, technical-setup, test-design, traceability | fail-closed-gates, independent-review, model-provenance, provider-neutrality |
| PARTIAL | — | — | — |
| FAIL | — | — | — |
| NOT_APPLICABLE / optional | — | effort-estimation | — |
