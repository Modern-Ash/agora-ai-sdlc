...
| --- | --- | --- | --- |
| Current result | **PARTIAL** (executable repository conformance) | **PARTIAL** (executable repository conformance against the public profile) | **PASS** (additive governance only) |
| PASS | ai-initiated-planning, bolts, brownfield-semantic-elevation, domain-design, forward-backward-traceability, human-validation, intent, level-1-plan, non-functional-requirements, operations-observability, persistent-context, quality-reviewer, recursive-planning, units | change-configuration-management, code-review, cross-repository-impact, documentation, domain-knowledge, ideation, operational-rules, organizational-readiness, quality-governance, review-gates, security-compliance, technical-setup, test-design, traceability | fail-closed-gates, independent-review, model-provenance, provider-neutrality |
| PARTIAL | deployment-units, logical-design, measurement-criteria, minimal-roles, operations-governed-remediation, risk-register, three-phase-lifecycle, user-stories | risk-issue-management | — |
| FAIL | — | — | — |
