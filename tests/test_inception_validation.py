...
def valid_output() -> str:
    return (
        ...
        "## User Stories\n\n"
        "US-001 captures deterministic interpreter behavior as the user-facing contract.\n\n"
        "## Non-functional requirements\n\n"
        "Determinism, bounded execution and no arbitrary generated-code execution.\n\n"
        "## Measurement Criteria\n\n"
        "All acceptance criteria are proven by deterministic automated tests.\n\n"
        "## Proposed Units\n\n"
        ...
        "## Risk Register\n\n"
        "Risk: semantic drift from the canonical program model; mitigate with shared deterministic tests.\n\n"
